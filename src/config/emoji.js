...
const emojiBaseUrl = `https://yx-web.nosdn.127.net/webdoc/h5/emoji`
...
const emojiCommonList = []
for (let i = 0; i < emojiCommon.length; i++) {
  emojiCommonList.push({
    type: 'emoji',
    name: 'emoji',
    key: emojiCommon[i],
    img: emojiList.emoji[emojiCommon[i]].img
  })
}
